...
export default getMuiTheme({
  ...
  palette: {
    // <====== Override MuiColors ====== >
    primary1Color: colors.primaryBlue,
    primary2Color: colors.primaryBlue,
      // primary3Color: colors.errorRed,
    accent1Color: colors.primaryBlue,
      // accent2Color: colors.errorRed,
      // accent3Color: colors.errorRed,
    textColor: colors.greyishBrown,
    alternateTextColor: colors.white,
    canvasColor: colors.white,
      // borderColor: colors.errorRed,
      // disabledColor: colors.errorRed,
    pickerHeaderColor: colors.primaryBlue,
    clockCircleColor: colors.paleGrey,
  ...
  tableRow: {
    selectedColor: colors.paleGrey,
  },
      textField: {
        // textColor: colors.primaryBlue,
        // hintColor: colors.primaryBlue,
        floatingLabelColor: colors.greyishBrown,
...
// Here is the default muiTheme, i.e. there are properties that we can
// override globally.
//
// Source: https://github.com/mui-org/material-ui/blob/master/src/styles/getMuiTheme.js
//
